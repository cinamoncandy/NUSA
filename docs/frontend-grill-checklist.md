...
- DONE — card/chip/section/data-row visual language.
- DONE — Markets compact segmented navigation with accessibility semantics.
- DONE — persistent PAPER / READ ONLY authority language.
- DONE — Portfolio numeric hierarchy and account-vs-position separation.
- DONE — PAPER screen suppresses fake mutation controls in read-only mode.
- DONE — explicit loading/error/empty/disconnected states in core workspaces.
