...
test("mobile source keeps read projections separate while exposing only explicit PAPER mutation", () => {
  ...
  assert.match(app, /InMemoryDashboardCredentialSession/); assert.match(app, /snapshot\?\.portfolio/); assert.match(app, /snapshot\?\.orders/); assert.match(app, /snapshot\.markets/);
