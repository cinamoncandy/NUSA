...
test("light and dark themes expose frozen semantic intelligence tokens", () => {
  ...
  assert.equal(dark.colors.background, "#050708");
  assert.equal(dark.colors.surfaceSunken, "#070A0B");
  assert.equal(dark.colors.primary, "#B8F2DD");
...
test("common component contracts consume obsidian finance theme tokens", () => {
