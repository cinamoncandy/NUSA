...
class FirstScoredBuy { constructor() { this.id = "first-scored-buy"; this.name = "First Scored Buy"; } onTick(tick) { return { type: tick.timestamp === 4 ? "BUY" : "HOLD", reason: "first-scored", confidence: 0, timestamp: tick.timestamp }; } reset() {} }
