...
test("SqliteDatabase fresh file applies accounting schema and exposes all tables", () => {
  ...
  try {
    ...
    assert.equal(reopened.migrationResult.currentVersion, "024_research_intelligence_memory");
