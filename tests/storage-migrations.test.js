...
test("SqliteDatabase fresh file applies accounting schema and exposes all tables", () => {
  ...
  try {
    ...
    assert.equal(reopened.migrationResult.currentVersion, "018_paper_public_market_observations");
