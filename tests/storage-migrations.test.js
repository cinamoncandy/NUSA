...
test("SqliteDatabase fresh file applies accounting schema and exposes all tables", () => {
  ...
  try {
    assert.deepEqual(db.migrationResult.applied, ["001_position_accounting", "002_research_memory", "003_governance_control", "004_compliance_control_plane", "005_resilience_control_plane", "006_rules_control_plane", "007_multi_agent_governance", "008_cloud_dashboard_snapshots", "009_cloud_paper_accounts", "010_risk_safety_integration", "011_research_evaluation_ledger", "012_candidate_promotion_runtime", "013_research_automation_sessions", "014_research_hypothesis_events"]);
    assert.equal(db.migrationResult.currentVersion, "014_research_hypothesis_events");
  ...
  try {
    ...
    assert.equal(reopened.migrationResult.currentVersion, "014_research_hypothesis_events");
