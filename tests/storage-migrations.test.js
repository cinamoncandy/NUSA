...
test("SqliteDatabase fresh file applies accounting schema and exposes all tables", () => {
  ...
  try {
    ...
    assert.equal(db.migrationResult.currentVersion, "018_cloud_paper_account_history");
  ...
  try {
    ...
    assert.equal(reopened.migrationResult.currentVersion, "018_cloud_paper_account_history");
