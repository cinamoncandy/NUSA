...
const credentialCases = [
  ...
  ["quoted-null-string", 'Authorization: "null"\n'],
  ["quoted-undefined-string", 'Authorization: "undefined"\n'],
  ["quoted-json-undefined", `${JSON.stringify({ Authorization: "undefined" })}\n`],
  ...
  ["nested-bracket-property", 'request["headers"]["Authorization"] = "Bearer abc";\n'],
  ...
  ["set-header", 'request.setHeader("Authorization", "Bearer abc")\n'],
  ["append-header", 'request.appendHeader("Authorization", "Basic dXNlcjpwYXNzd29yZA==")\n'],
  ...
  ["absence-before-credential-assignment", 'Authorization: ""\nAuthorization: Bearer abc\n'],
  ["absence-before-credential-setter", 'headers.set("Authorization", "")\nheaders.set("Authorization", "Bearer abc")\n'],
  ["absence-before-credential-pair", '[["Authorization", ""], ["Authorization", "Bearer abc"]]\n'],
];
...
const absenceCases = [
  ...
  ["null-semicolon", "Authorization: null;\n"],
  ["undefined-value", "Authorization = undefined\n"],
  ["undefined-semicolon", "Authorization = undefined;\n"],
  ["empty-bracket-assignment", 'headers["Authorization"] = "";\n'],
  ["empty-dot-property", 'headers.Authorization = "";\n'],
  ["empty-nested-bracket-property", 'request["headers"]["Authorization"] = "";\n'],
  ["empty-tuple-pair", '[["Authorization", ""]]\n'],
  ["null-tuple-pair", '[["Authorization", null]]\n'],
  ["empty-setter", 'headers.set("Authorization", "")\n'],
  ["null-setter", 'headers.set("Authorization", null)\n'],
  ["undefined-setter", 'headers.set("Authorization", undefined);\n'],
  ["empty-set-header", 'request.setHeader("Authorization", "")\n'],
  ["null-set-header", 'request.setHeader("Authorization", null)\n'],
  ["empty-append-header", 'request.appendHeader("Authorization", "")\n'],
  ["empty-set-request-header", 'xhr.setRequestHeader("Authorization", "")\n'],
  ["null-set-request-header", 'xhr.setRequestHeader("Authorization", null)\n'],
