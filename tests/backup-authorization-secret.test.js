...
const credentialCases = [
  ...
  ["quoted-undefined-string", `${JSON.stringify({ Authorization: "undefined" })}\n`],
  ...
  ["shadowed-tuple", '[["Authorization", ""], ["Authorization", "Basic dXNlcjpwYXNzd29yZA=="]]\n'],
...
const absenceCases = [
  ...
  ["undefined-set-request-header", 'xhr.setRequestHeader("Authorization", undefined)\n'],
