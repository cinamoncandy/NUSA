...
const result = (overrides = {}) => ({
  ...
  failureCodes: [],
  outputHashes: [],
  structuredOutputs: [{ schemaVersion: 1, role: "STRATEGY_PROPOSER", evidenceReferences: ["e-1"], payload: { rawProbability: 0.73 } }],
  liveAuthority: "NONE",
...
test("bridge refuses incomplete, failed, missing, or invalid proposer output", () => {
