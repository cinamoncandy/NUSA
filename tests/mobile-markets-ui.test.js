...
test("Markets defaults to the chart and keeps it reachable even without real candle data", () => {
  ...
  // Real candle wiring landed (see PR #526) and moved into the HOME canvas shell:
  // App passes public evidence to Home, Home builds the chart model -- no placeholder gap.
