...
test("desktop SQLite persists immutable research manifests and reports", () => {
  ...
  const report = Object.freeze({ runId: manifest.runId, runType: "WALK_FORWARD", status: "PASS", reasons: [], checkedAt: "2026-07-15T00:00:00.000Z", resultChecksum: "b".repeat(64) });
