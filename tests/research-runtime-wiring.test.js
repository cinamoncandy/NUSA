...
test("cloud runtime forwards the same public ticker path to the research runtime", async () => {
  ...
  const handle = startCloudRuntime({ NUSA_CLOUD_DASHBOARD_PORT: "41911", NUSA_CLOUD_DASHBOARD_TOKEN: "research-runtime-wiring-token-32bytes-min", NUSA_CLOUD_UPBIT_PUBLIC_DATA: "true", NUSA_CLOUD_UPBIT_MARKETS: "KRW-BTC" }, undefined, undefined, factory, undefined, undefined, undefined, runtime);
  try {
