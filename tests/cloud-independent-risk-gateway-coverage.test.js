// Cloud counterpart of tests/independent-risk-gateway-coverage.test.js -- same coverage table
// and assertions, pointed at the cloud build output (apps/cloud/src/independentRiskGateway.js).
const test = require("node:test");
const assert = require("node:assert/strict");
const fs = require("node:fs");
const path = require("node:path");
const { evaluatePreTradeRisk, evaluateDeploymentSafety, RISK_REASON_ORDER, DEPLOYMENT_REASON_ORDER } = require("../dist/apps/cloud/src/independentRiskGateway.js");
