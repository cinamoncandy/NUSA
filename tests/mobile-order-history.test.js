...
test("order history UI uses design system and remains reachable as a read-only deeper job", () => {
  ...
  assert.match(app, /detailSurface === "Order"/);
  assert.doesNotMatch(app, /activeTab === "Order"/);
