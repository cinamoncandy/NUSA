// Proves the cloud-ported independentRiskGateway.ts (apps/cloud/src) behaves identically to
// the desktop original it was copied from -- same assertions as tests/independent-risk-gateway.test.js,
// pointed at the cloud build output. If this file and the desktop one ever diverge, the port
// has drifted from the source it claims to be a faithful copy of.
const test = require("node:test");
const assert = require("node:assert/strict");
const { evaluatePreTradeRisk, evaluateDeploymentSafety } = require("../dist/apps/cloud/src/independentRiskGateway.js");
