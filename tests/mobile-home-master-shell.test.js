...
test("HOME uses one canonical autonomous-intelligence NUSA header instead of the legacy global shell header", () => {
  ...
  assert.match(home, /style=\{styles\.masterRail\} testID="home-master-rail"/);
