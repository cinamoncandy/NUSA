...
test("production HOME exposes exact packaged build source identity and projection-truth family", () => {
  ...
  assert.match(homeView, /BUILD \{packagedBuildLabel\} · projection truth only/);
});
