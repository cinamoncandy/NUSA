...
Coverage baseline 2026-08-02: added c8 and Vitest V8 coverage, source maps, unified JSON/Markdown/LCOV/HTML reporting, CI artifact upload, and report-only threshold policy. Final baseline: 342 modules, 84.37% statements/lines, 76.37% branches, 92.56% functions. Core 291 isolated files, UI 4 tests, and E2E 4 tests PASS. Browser-page coverage remains uninstrumented by the current static-server Playwright setup. Report: `docs/audits/coverage-baseline-2026-08-02.md`.
