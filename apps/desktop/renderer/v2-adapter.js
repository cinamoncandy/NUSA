(function mountNusaV2Adapter(global) {
  ...
  function alignRuntimeLanguage() {
    ...
    root.querySelectorAll('[data-simple-nav="strategy"].v2-link').forEach((button) => { button.textContent = "NUSA 자세히 보기"; });
  }
  ...
  const timelineObserver = new MutationObserver(() => mirrorTimeline());
