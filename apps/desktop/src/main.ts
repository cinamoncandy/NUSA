...
import { PaperBroker, type PaperOrder } from "./paper/paperBroker";
import { parsePaperOrderIpc } from "./ipc/paperIpcValidation";
...
import { PERSISTENCE_FAULT_MESSAGE, PERSISTENCE_REPAIR_MESSAGE, RuntimeCommandService, type PaperCommandRiskGate } from "./control/runtimeCommandService";
...
import { parseShadowSessionIpc, parseShadowStartIpc, parseShadowStatusIpc } from "./ipc/shadowIpcValidation";
...
import { answerSignalFollowUp, createAnthropicSignalExplainerClient, explainStrategySignal, type AiSignalExplainerClient, type SignalExplanationRequest, type AiSignalExplanation, type AiSignalFollowUpAnswer } from "./ai/aiSignalExplainer";
import { AiChallengerObserver, createAnthropicChallengerClient, type AiChallengerClient } from "./ai/aiChallengerObserver";
import { createAnthropicDisagreementExplainerClient, explainChallengerDisagreement, type AiDisagreementExplainerClient } from "./ai/aiChallengerDisagreementExplainer";
import { createAnthropicSessionSummaryClient, summarizeSession, type AiSessionSummaryClient, type SessionSummaryRequest, type AiSessionSummary } from "./ai/aiSessionSummary";
import { createAnthropicRegimeExplainerClient, explainRegime, type AiRegimeExplainerClient, type RegimeExplanationRequest, type AiRegimeExplanation } from "./ai/aiRegimeExplainer";
import { evaluateStrategyRegime } from "./strategy/regimePolicy";
import { createAnthropicRiskCommentaryClient, explainRiskCommentary, type AiRiskCommentaryClient, type RiskCommentaryRequest, type AiRiskCommentary } from "./ai/aiRiskCommentary";
...
import { approveRecoveryReview, compareRecoveryState, completeRecovery, RecoveryReviewState } from "./recovery/recoveryReconciliation";
import { parseRecoveryCompleteIpc, parseRecoveryOwnerReviewIpc, parseRecoveryReconcileIpc, parseRecoveryStatusIpc } from "./ipc/recoveryIpcValidation";
...
import { parseAppSettingsIpc, parseFirstRunAcknowledgeIpc, parseOpenFolderIpc, parseProductIpc } from "./ipc/productIpcValidation";
...
import { parseKillSwitchReleaseIpc, parseKillSwitchActivateIpc } from "./ipc/killSwitchIpcValidation";
