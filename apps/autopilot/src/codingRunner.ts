...
const UNSUPPORTED_CODING_WORKERS_AI_MODELS = new Set([
...
export async function executeCodingRunner(
  ...
  // Dashboard vars can outlive provider capability/deprecation changes; reject deprecated or JSON-mode-incompatible models.
  const model = !configuredModel || UNSUPPORTED_CODING_WORKERS_AI_MODELS.has(configuredModel)
