...
const styles = StyleSheet.create({
  content: { paddingHorizontal: 20, paddingTop: 20, paddingBottom: 44, gap: 20, width: "100%", maxWidth: 1080, alignSelf: "center" }, state: { flex: 1, justifyContent: "center", padding: 20, gap: 12 }, hero: { gap: 5, paddingVertical: 6 }, heroValue: { fontSize: 42, lineHeight: 49, fontWeight: "800", letterSpacing: -1.8, fontVariant: ["tabular-nums"] }, pnl: { fontSize: 15, lineHeight: 21, fontWeight: "700" },
  ...
  eyebrow: { fontSize: 10, lineHeight: 15, fontWeight: "800", letterSpacing: 1.1 }, title: { fontSize: 16, lineHeight: 22, fontWeight: "800" }, market: { fontSize: 24, lineHeight: 30, fontWeight: "800" }, cash: { marginTop: 4, fontSize: 23, lineHeight: 29, fontWeight: "800" }, meta: { fontSize: 12, lineHeight: 18 },
});