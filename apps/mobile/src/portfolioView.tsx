    ...
    <View style={[styles.commandHero, { borderColor: theme.colors.border }]} testID="portfolio-command-hero">
      <View style={styles.commandHeader}>
        <View style={styles.commandTitleWrap}>
          <Text style={[styles.commandEyebrow, { color: theme.colors.primary }]}>CAPITAL SUPERVISION</Text>
          <Text style={[styles.commandTitle, { color: theme.colors.text }]}>KNOW WHAT IS WORKING.</Text>
          <Text style={[styles.commandDetail, { color: theme.colors.textMuted }]}>PAPER 자본, 노출, 회계 결과를 먼저 보고 REAL_READ_ONLY 기준선은 별도로 확인합니다.</Text>
        </View>
