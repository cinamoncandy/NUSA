...
const styles=StyleSheet.create({
 ...
 tabs:{height:40,flexDirection:"row",borderBottomWidth:StyleSheet.hairlineWidth,borderBottomColor:"#1B2830"},tab:{marginRight:22,justifyContent:"center",borderBottomWidth:2,borderBottomColor:"transparent"},
 sphereCard:{minHeight:290,borderWidth:1,borderRadius:18,backgroundColor:"#081018",padding:18,flexDirection:"row",alignItems:"center",gap:18},
 sphere:{width:190,height:190,borderRadius:190,borderWidth:1,alignItems:"center",justifyContent:"center",position:"relative",backgroundColor:"#0A1722"},orbitA:{position:"absolute",width:156,height:156,borderRadius:156,borderWidth:1},orbitB:{position:"absolute",width:110,height:178,borderRadius:110,borderWidth:1},orbitC:{position:"absolute",width:178,height:92,borderRadius:178,borderWidth:1},sphereWord:{fontSize:17,fontWeight:"800"},
 ...
 map:{borderWidth:1,borderRadius:16,padding:14,gap:10},mapTitle:{fontSize:13,fontWeight:"800"},mapGrid:{height:130,position:"relative",backgroundColor:"#071018"},axisH:{position:"absolute",left:18,right:8,bottom:22,height:1},axisV:{position:"absolute",left:18,top:10,bottom:22,width:1},mapPoint:{position:"absolute",width:13,height:13,borderRadius:13},note:{fontSize:9,lineHeight:14},safety:{fontSize:8,fontWeight:"800",letterSpacing:1,textAlign:"center"}
});