...
const styles = StyleSheet.create({
  ...
  marketIdentity: { flex: 1, minWidth: 84 },
  ...
  favorite: { minWidth: 52, height: 44, paddingHorizontal: 8, borderRadius: 12, borderWidth: 1, alignItems: "center", justifyContent: "center" },
