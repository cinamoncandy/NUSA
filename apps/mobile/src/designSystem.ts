...
export const designPresets: Readonly<Record<DesignPresetName, DesignPreset>> = Object.freeze({
  ...
  master: Object.freeze({
    ...
    dark: Object.freeze({
      background: "#070A10", surface: "#0D121B", surfaceRaised: "#121927", surfaceSunken: "#090E16",
      text: "#F7F9FC", textMuted: "#8B96A8", primary: "#F7F9FC", primarySoft: "#12253A", onPrimary: "#071018",
      navSurface: "#0A0F17", border: "#1B2636", borderStrong: "#34465F", info: "#9FB0C5", focus: "#7DD3FC",
      neonGlow: "rgba(65, 126, 255, 0.18)",
    }),
    light: Object.freeze({
      background: "#F3F6FA", surface: "#FFFFFF", surfaceRaised: "#EAF0F7", surfaceSunken: "#EDF2F8",
      text: "#111827", textMuted: "#667085", primary: "#0F172A", primarySoft: "#E0EEFF", onPrimary: "#FFFFFF",
      navSurface: "#FFFFFF", border: "#D7E0EA", borderStrong: "#A7B5C6", info: "#526277", focus: "#2563EB",
      neonGlow: "rgba(37, 99, 235, 0.10)",
    }),
    typography: Object.freeze({ micro: 10, caption: 12, body: 15, title: 21, heading: 30, display: 42, hero: 56 }),
    layout: Object.freeze({ screenPadding: 18, sectionGap: 16, cardPadding: 18, heroRadius: 20 }),
    radii: Object.freeze({ sm: 8, md: 12, lg: 16, xl: 22, full: 9999 as const }),
  }),
});
...
export function createTheme(mode: ThemeMode, presetName: DesignPresetName = "master"): Theme {
  ...
  return freezeTheme({
    ...
    colors: {
      ...
      aiSignalStart: dark ? "#7C5CFF" : "#6844E8",
      aiSignalMid: dark ? "#417EFF" : "#2563EB",
      aiSignalEnd: dark ? "#2DD4BF" : "#0F766E",
      aiSignalSoft: dark ? "#101C2C" : "#EAF4FF",
      terrain: dark ? "#BFD6FF" : "#334155",
      chartUp: dark ? "#2DD4BF" : "#0F766E",
      chartDown: dark ? "#FB7185" : "#BE123C",
      navSurface: palette.navSurface,
      border: palette.border,
      borderStrong: palette.borderStrong,
      success: dark ? "#2DD4BF" : "#0F766E",
      warning: dark ? "#F2C96D" : "#8A6116",
      danger: dark ? "#FB7185" : "#BE123C",
      info: palette.info,
      onDanger: dark ? "#111827" : "#FFFFFF",
      focus: palette.focus,
      neonPurple: "#7C5CFF",
      neonBlue: "#417EFF",
      neonTeal: "#2DD4BF",
    ...
    radii: preset.radii,
    shadows: {
      sm: { color: dark ? "#000000" : "#0F172A", offset: { width: 0, height: 4 }, opacity: dark ? 0.22 : 0.05, radius: 12, elevation: 1 },
      md: { color: dark ? "#000000" : "#0F172A", offset: { width: 0, height: 12 }, opacity: dark ? 0.34 : 0.09, radius: 26, elevation: 3 },
      focus: { color: palette.focus, offset: { width: 0, height: 0 }, opacity: 0.28, radius: 5, elevation: 0 },
      glow: { color: "#417EFF", offset: { width: 0, height: 0 }, opacity: dark ? 0.32 : 0.14, radius: 26, elevation: 2 },
    },
