...
export function createTheme(mode: ThemeMode): Theme {
  ...
  return freezeTheme({
    mode,
    colors: {
      background: dark ? "#070B0D" : "#F2F7F5",
      surface: dark ? "#0E171A" : "#FFFFFF",
      surfaceRaised: dark ? "#152226" : "#E6F1EE",
      surfaceSunken: dark ? "#0A1114" : "#DDEAE6",
      text: dark ? "#F3FAF8" : "#0D1715",
      textMuted: dark ? "#91A6A0" : "#60716D",
      primary: dark ? "#46E0C2" : "#0A6B59",
      primarySoft: dark ? "#12352F" : "#D5F1E9",
      onPrimary: dark ? "#04110E" : "#FFFFFF",
      aiSignalStart: "#9D7BFF",
      aiSignalMid: "#5D91FF",
      aiSignalEnd: "#46E0C2",
      aiSignalSoft: dark ? "#171A31" : "#EEEAFE",
      terrain: dark ? "#BFEDE4" : "#29453F",
      chartUp: dark ? "#46E0C2" : "#0A6B59",
      chartDown: dark ? "#FF7F9A" : "#A52F49",
      navSurface: dark ? "#0B1316" : "#F9FCFB",
      border: dark ? "#213238" : "#C8D8D3",
      borderStrong: dark ? "#3B555D" : "#91AAA3",
      success: dark ? "#46E0C2" : "#0A6B59",
      warning: dark ? "#E8C86E" : "#8A6516",
      danger: dark ? "#FF7F9A" : "#A52F49",
      info: dark ? "#9CB8C1" : "#50676F",
      onDanger: dark ? "#11151B" : "#FFFFFF",
      focus: dark ? "#BFF7EC" : "#0A6B59",
      neonPurple: "#9D7BFF",
      neonBlue: "#5D91FF",
      neonTeal: "#46E0C2",
      neonGlow: dark ? "rgba(70, 224, 194, 0.22)" : "rgba(70, 224, 194, 0.10)",
    },
    typography: {
    ...
    shadows: {
      sm: { color: dark ? "#00110D" : "#000000", offset: { width: 0, height: 3 }, opacity: dark ? 0.28 : 0.04, radius: 10, elevation: 1 },
      md: { color: dark ? "#00110D" : "#000000", offset: { width: 0, height: 10 }, opacity: dark ? 0.34 : 0.07, radius: 22, elevation: 3 },
      focus: { color: dark ? "#46E0C2" : "#0A6B59", offset: { width: 0, height: 0 }, opacity: 0.28, radius: 4, elevation: 0 },
      glow: { color: "#46E0C2", offset: { width: 0, height: 0 }, opacity: dark ? 0.42 : 0.2, radius: 24, elevation: 2 },
    },
