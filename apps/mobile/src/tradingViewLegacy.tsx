...
const styles = StyleSheet.create({
  ...
  marketPanel: { borderWidth: 1, borderRadius: 18, padding: 14, gap: 10 }, activityPanel: { borderWidth: 1, borderRadius: 18, padding: 16, gap: 10 }, panelHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }, panelTitle: { marginTop: 4, fontSize: 18, lineHeight: 24, fontWeight: "800" }, miniChart: { height: 230, flexDirection: "row", alignItems: "stretch", gap: 1, overflow: "hidden", position: "relative", backgroundColor: "#050710" }, chartColumn: { flex: 1, minWidth: 2, position: "relative" }, chartWick: { position: "absolute", left: "50%", width: 1 }, chartBody: { position: "absolute", left: "15%", right: "15%", minHeight: 2 },
