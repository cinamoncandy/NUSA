...
const styles = StyleSheet.create({
  content: { paddingHorizontal: 20, paddingTop: 14, gap: 16, paddingBottom: 44, width: "100%", maxWidth: 720, alignSelf: "center" },
  ...
  orderSideHero: { paddingTop: 2, paddingBottom: 2 }, hiddenActivity: { position: "absolute", width: 1, height: 1, opacity: 0 },
  quoteHero: { paddingVertical: 8, gap: 7 }, quoteTop: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }, statusRow: { flexDirection: "row", gap: 7, flexWrap: "wrap", justifyContent: "flex-end" }, eyebrow: { fontSize: 10, lineHeight: 15, fontWeight: "800", letterSpacing: 1.2 }, market: { marginTop: 4, fontSize: 18, lineHeight: 23, fontWeight: "800" }, price: { fontSize: 38, lineHeight: 45, fontWeight: "800", letterSpacing: -1.4, fontVariant: ["tabular-nums"] }, quoteMeta: { fontSize: 11, lineHeight: 17 },
  marketPanel: { borderWidth: 1, borderRadius: 18, padding: 14, gap: 10 }, activityPanel: { borderWidth: 1, borderRadius: 18, padding: 16, gap: 10 }, panelHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }, panelTitle: { marginTop: 4, fontSize: 18, lineHeight: 24, fontWeight: "800" }, miniChart: { height: 230, flexDirection: "row", alignItems: "stretch", gap: 1, overflow: "hidden", position: "relative", backgroundColor: wealthProductColors.c28 }, chartColumn: { flex: 1, minWidth: 2, position: "relative" }, chartWick: { position: "absolute", left: "50%", width: 1 }, chartBody: { position: "absolute", left: "15%", right: "15%", minHeight: 2 },
