...
const styles = StyleSheet.create({
  ...
  heroFacts: { flex: 1, gap: 8 },
  fact: { minHeight: 44, justifyContent: "space-between", paddingBottom: 7, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: "rgba(255,255,255,0.08)" },
  ...
  panel: { borderWidth: 1, borderRadius: 12, padding: 15, gap: 10 },
  ...
  nextActionPanel: { borderWidth: 1, borderRadius: 12, padding: 16, gap: 7 },
  nextAction: { fontSize: 20, lineHeight: 29, fontWeight: "600" },
  ...
  errorPanel: { borderWidth: 1, borderRadius: 12, padding: 14, gap: 6 },
  errorTitle: { fontSize: 12, lineHeight: 17, fontWeight: "700" },
  footer: { textAlign: "center", fontSize: 10, lineHeight: 18, letterSpacing: 0.5, paddingTop: 4 },
});