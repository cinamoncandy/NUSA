...
const styles = StyleSheet.create({
  ...
  strategyIcon:{width:34,height:34,borderRadius:10,borderWidth:1,alignItems:"center",justifyContent:"center",backgroundColor:wealthProductColors.c71},strategyIconText:{color:ACCENT_SOFT,fontSize:11,fontWeight:"900"},strategyMain:{flex:1,minWidth:0},strategyName:{color:TEXT,fontSize:12,fontWeight:"800"},strategySub:{color:MUTED,fontSize:8,marginTop:3},strategyTail:{alignItems:"flex-end"},strategyAuthority:{color:ACCENT_SOFT,fontSize:7,fontWeight:"800"},strategyReturn:{color:MUTED,fontSize:8,fontWeight:"800",marginTop:4},strategyChevron:{color:MUTED,fontSize:20},
