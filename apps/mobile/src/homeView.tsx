...
const styles = StyleSheet.create({
  ...
  grid: { flexDirection: "row", flexWrap: "wrap", gap: 10 }, column: { flexGrow: 1, flexBasis: 440 }, nextAction: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", gap: 14, flexWrap: "wrap", paddingVertical: 4 }, nextActionCopy: { flexGrow: 1, flexShrink: 1, minWidth: 180 }, primaryActions: { flexDirection: "row", gap: 10, flexWrap: "wrap" },
