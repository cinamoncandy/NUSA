...
export interface PersonalPaperOperationsClientOptions { readonly baseUrl: string; readonly credentialProvider: DashboardCredentialProvider; readonly request?: typeof fetch; }
...
/** Uses only an explicitly saved endpoint. The App's historical localhost fallback is ignored unless saved by the operator. */
