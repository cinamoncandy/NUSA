...
export function AndroidEHomeView(props: Props) {
  const { theme } = useTheme();
  ...
  >
    ...
    <View style={styles.brandRow} testID="android-e-brand">
      ...
      <Text style={[styles.conceptMark, { color: theme.colors.textMuted }]}>ANDROID · TEMP E</Text>
    </View>
    ...
    <View style={styles.hero} testID="android-e-now">
    ...
    <View style={[styles.marketStrip, { borderColor: theme.colors.border, backgroundColor: theme.colors.surfaceSunken }]} testID="android-e-market-strip">
    ...
    <View style={[styles.healthSurface, { borderColor: theme.colors.border, backgroundColor: theme.colors.surface }]} testID="android-e-health">
    ...
    <Pressable accessibilityRole="button" onPress={() => props.onNavigate("AiSignal")} style={({ pressed }) => [styles.insightSurface, { borderColor: theme.colors.borderStrong, backgroundColor: theme.colors.surfaceRaised, opacity: pressed ? theme.interaction.pressedOpacity : 1 }]} testID="android-e-insight">
    ...
    <View style={styles.focusRow} testID="android-e-focus">
    ...
    <View style={[styles.sheet, { borderColor: theme.colors.borderStrong, backgroundColor: theme.colors.surfaceRaised }]} testID="android-e-evidence-sheet">
    ...
    <View style={styles.ownerActions} testID="android-e-owner-actions">
      <Pressable accessibilityRole="button" onPress={() => {
