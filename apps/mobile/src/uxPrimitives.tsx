...
const styles = StyleSheet.create({
  ...
  segmented: { flexDirection: "row", minHeight: 54, padding: 3, borderRadius: 14, borderWidth: 1, gap: 3 },
  segment: { flex: 1, minHeight: 48, borderRadius: 11, borderWidth: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: 12 },
