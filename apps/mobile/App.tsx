...
const styles = StyleSheet.create({
  ...
  authorityStrip: { minHeight: 38, borderBottomWidth: 1, alignItems: "center" }, homeAuthorityStrip: { minHeight: 30 }, authorityStripInner: { width: "100%", maxWidth: 1080, paddingHorizontal: 20, minHeight: 38, flexDirection: "row", flexWrap: "wrap", gap: 7, alignItems: "center" }, homeAuthorityStripInner: { width: "100%", maxWidth: 1080, paddingHorizontal: 20, minHeight: 30, flexDirection: "row", gap: 10, alignItems: "center" }, homeAuthorityText: { fontSize: 11, lineHeight: 16, fontWeight: "800", letterSpacing: 0.65 }, authorityCopy: { fontSize: 11, fontWeight: "600", marginLeft: 2 },
