...
const tabLabels: Readonly<Record<PrimaryTab, string>> = { Home: "HOME", Markets: "MARKETS", Paper: "PAPER", Portfolio: "PORTFOLIO", AiSignal: "AI SIGNAL" };
const tabDisplayLabels: Readonly<Record<PrimaryTab, string>> = { Home: "HOME", Markets: "MARKETS", Paper: "PAPER", Portfolio: "PORTFOLIO", AiSignal: "AI SIGNAL" };
...
const styles = StyleSheet.create({
  ...
  navigationFrame: { paddingHorizontal: 0, paddingTop: 0, paddingBottom: 0, alignItems: "center" }, navigation: { width: "100%", maxWidth: 720, borderTopWidth: 1, borderWidth: 0, borderRadius: 0, alignItems: "center", shadowOpacity: 0, shadowRadius: 0, shadowOffset: { width: 0, height: 0 }, elevation: 0 }, navigationInner: { width: "100%", flexDirection: "row", padding: 0, gap: 0 }, navItem: { flex: 1, minHeight: 66, borderRadius: 0, alignItems: "center", justifyContent: "center", gap: 3, paddingHorizontal: 4, paddingTop: 6 }, navIndicator: { height: 2, width: 22, borderRadius: 999, marginTop: 1 }, navLabel: { fontSize: 8, fontWeight: "800", letterSpacing: 0.65 }, navLabelActive: { fontWeight: "900", letterSpacing: 0.25 },
