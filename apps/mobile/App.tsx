...
const styles = StyleSheet.create({
  ...
  header: { minHeight: 56, borderBottomWidth: StyleSheet.hairlineWidth, alignItems: "center" }, headerInner: { width: "100%", maxWidth: 1080, paddingHorizontal: 18, paddingVertical: 6, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, headerBrand: { flexDirection: "row", alignItems: "center", gap: 8 }, brand: { fontSize: 18, fontWeight: "900", letterSpacing: 1.8 }, eyebrow: { fontSize: 8, fontWeight: "800", letterSpacing: 1.35, marginTop: -1 },
