...
/**
 * Converts machine-verifiable runtime/test/workflow state into the canonical
 * LIVE-readiness booleans. No human checkbox exists here: each non-owner
 * prerequisite auto-passes when its objective source state is green, and
 * auto-revokes on the next recomputation if that source regresses.
 */
