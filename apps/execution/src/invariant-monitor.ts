...
export interface InvariantMonitorResult { readonly healthy:boolean; readonly criticalFailureIds:readonly string[]; readonly warningFailureIds:readonly string[]; readonly unknownIds:readonly string[]; readonly observations:readonly RuntimeInvariantObservation[]; }
export function evaluateRuntimeInvariants(observations:readonly RuntimeInvariantObservation[]):InvariantMonitorResult{
 ...
 return Object.freeze({healthy:critical.length===0&&unknown.length===0,criticalFailureIds:Object.freeze(critical),warningFailureIds:Object.freeze(warning),unknownIds:Object.freeze(unknown),observations:Object.freeze(ordered)});
}
