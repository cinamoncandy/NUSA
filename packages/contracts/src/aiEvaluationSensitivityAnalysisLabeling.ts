/** Sensitivity-analysis / advisory-evidence separation for WO-AI-011. */
...
export function attachSensitivityAnalysis<T>(bundle: EvaluationResultWithSensitivity<T>, analysis: SensitivityAnalysis<T>): EvaluationResultWithSensitivity<T> | null {
